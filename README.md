...
**[👉 라이브 데모 보기](https://andrewylies-dashboard.vercel.app)**

실제 동작하는 대시보드를 확인하실 수 있습니다.  
필터링, 차트 인터렉션, 데이터 테이블 등 모든 기능을 직접 체험해보세요.
...
> **📌 Note:** 이 프로젝트는 개인 학습 및 포트폴리오 목적의 토이 프로젝트입니다.
